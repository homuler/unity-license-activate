...
async function start(email, password, alf, verification, authenticatorKey, emailPassword) {
  ...
  try {
    ...
    await page.waitForFunction(() => document.querySelectorAll('input[class="req"], input[class="verify_code"], input[name="licenseFile"]').length);
